...
export default function App({ Component, pageProps }) {
  ...
  // Default SEO data
  const defaultSEO = {
    title: 'BotBuddy Customer Analytics - AI-Powered Shopify Analytics & Segmentation',
    description: 'Transform your Shopify store with BotBuddy Customer Analytics. Get AI-powered insights, customer segmentation, and automated marketing campaigns to boost sales and retention.',
    keywords: 'Shopify analytics, customer segmentation, AI insights, e-commerce analytics, customer retention, marketing automation, Shopify app',
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image:alt" content="BotBuddy Customer Analytics Dashboard" />
        ...
        <meta name="twitter:image:alt" content="BotBuddy Customer Analytics Dashboard" />
